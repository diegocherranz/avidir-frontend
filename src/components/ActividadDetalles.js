    ...
    return (
        <div>
            <Container className="mx-3">
                <h4 className="mt-5 ">Actividad</h4>
                <h5 className="mt-5 ">{actividad.titulo}</h5>
                <p className="mt-3 ">Descripción: {actividad.descripcion}</p>
                <p className="mt-3 "><Clock /> {actividad.hora}</p>
                <p className="mt-3 ">Duración: {actividad.tiempo_completar} minutos</p>
            ...
            <Stack className="stack-buttons mx-5" direction="horizontal">
                ...
                <CheckCircleFill className="ms-auto" color="green" size={60} />
            </Stack>
            <BottomBarUsuario />
        </div>
    )
